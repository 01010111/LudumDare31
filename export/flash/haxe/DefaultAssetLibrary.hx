...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/actors.png", AssetType.IMAGE);
		...
		className.set ("assets/images/bush.png", __ASSET__assets_images_bush_png);
		type.set ("assets/images/bush.png", AssetType.IMAGE);
		className.set ("assets/images/castleL.png", __ASSET__assets_images_castlel_png);
		type.set ("assets/images/castleL.png", AssetType.IMAGE);
		className.set ("assets/images/castleR.png", __ASSET__assets_images_castler_png);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/bush.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/castleL.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/castleR.png";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/inventoryBox.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/itemShop.png";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/trashBox.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/weaponShop.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/well.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_bush_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
//@:bitmap("assets/images/bush.png") class __ASSET__assets_images_bush_png extends openfl.display.BitmapData {}
